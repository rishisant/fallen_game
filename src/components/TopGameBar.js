/*
    真田理志
    TOP GAME BAR
    USED FOR DISPLAYING THE BASIC GAME INFORMATION.
*/

import React, { useContext } from 'react';
import { GameContext } from '../contexts/GameContext';

import GOLD from '../assets/img/RES_1.png';
import TRUST from '../assets/img/RES_2.png';
import MAGIC from '../assets/img/RES_3.png';
...
const TopGameBar = () => {
    ...
    return (
        <div className='top-game-bar'>
            <div className='top-game-bar-content'>
                <div className='top-game-bar-item'>
                    <img src={GOLD} alt='GOLD' className='top-game-bar-image' />
                    <p className='top-game-bar-text'>{gameState.baseVariables.wealth} %</p>
                </div>
                <div className='top-game-bar-item'>
                    <img src={TRUST} alt='TRUST' className='top-game-bar-image' />
                    <p className='top-game-bar-text'>{gameState.baseVariables.trust} %</p>
                </div>
                <div className='top-game-bar-item'>
                    <img src={MAGIC} alt='MAGIC' className='top-game-bar-image' />
                    <p className='top-game-bar-text'>{gameState.baseVariables.magic} %</p>
                </div>
            </div>
        </div>
    );
